...
| Customer List Screen | This screen presents the list of all registered customers. For each customer, the following info is shown: <ul><li>1. Name</li><li> 2. Number of Employees 3. Size: if number of Employees is less than or equal 100, size is Small;<br> if greater than 10 and less than or equal to 1000, Medium; otherwise, Large When the user clicks on a customer name, the Contacts Detail Screen is shown.  |
